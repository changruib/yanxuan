<template>
  <div class="container">
    ...
    <div v-if="cartDetail !== undefined && cartDetail.length === 0" class="empty">
    ...
    <div v-else>
      <div v-for="(item, index) in cartDetail" :key="index" class="item">
        ...
        <i class="iconfont" @click="deleteGoods(item,index)">&#xe629;</i>
      </div>
    </div>

    <div class="footer" v-if="userinfo">
      <div class="checkall">
